...
Maratona de Ciência de Dados, Inteligência Artificial e IoT, organizada pela IBM e composta por 8 desafios, abrangendo desde aprendizado de máquina em Jupyter Notebooks até a utilização de diversos serviços e softwares da IBM Cloud, como o *Watson Speech to Text*, o *Natural Language Understanding* e o *Knowledge Studio*. **53ª colocação geral (Ranking Brasil)**. 
